...
\item[\refqualclass{checker/regex/qual}{RegexNNGroups}]
  indicates that the run-time value is a valid regular expression
  \code{String}. There are two parameters for the qualifier, \<groups>
  is the same as the optional parameter for \code{Regex}, \<nonNullGroups>
  ...
  non-regex string such as \<"1) first point">. Note that \code{Regex(1)}
  is exactly the same as \code{EnhancedRegex(groups = 1)}.
...
\caption{The subtyping relationship of the \code{Regex} annotation.
...
\begin{figure}
\includeimage{regexnngroups}{9cm}
...
the checker implicitly adds the \code{@RegexNNGroups} qualifier with
...
\code{Regex} or \code{RegexNNGroups} qualifier.
...
Two additional versions of \code{isRegex} method are also provided that take some additional
parameters. The \refmethod{checker/regex/util}{RegexUtil}{isRegex}{-java.lang.String-int-}
...
<<<<<<< HEAD
\refmethod{checker/regex/util}{RegexUtil}{isRegex}{-java.lang.String-int-int...-}
=======
\refmethod{checker/regex/util}{RegexUtil}{isRegex}{-java.lang.String-int-java.util.List-}
...
matches a \code{String} the groups in the \code{List} are guaranteed to match some
part of the \code{String}. The
