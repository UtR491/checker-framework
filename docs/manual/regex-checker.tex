...
verifies that the argument has at least the given number of groups and the
\refmethod{checker/regex/util}{RegexUtil}{isRegex}{-java.lang.String-int-java.util.List-}
verifies that the argument has at least the give number of groups and that when it
